...
import { getNewLotteryAddress, getLotteryProgram, getMasterAddress } from "../../lib/utils";
...
const create_loss_lottery = async (program: Program<Lottery>, wallet: AnchorWallet, connection: Connection, price: number) => {
