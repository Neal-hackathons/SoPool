...
Project's resume : So-pool is a no-loss lottery game on solana. Inspired by the famous PoolTogether protocol, players deposits (tickets) are staked on a rewarding protocol (lending, staking, etc...).
The lottery winner is rewarded with all the interests generated by the rewarding protocol, and every player can refund his tickets. Hence the "no loss".
